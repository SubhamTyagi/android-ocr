...
*   `:oldApp` : The old app code written in java and xml
...
### Translation
Help this app reach more users by translating the app on [Weblate](https://hosted.weblate.org/projects/android-ocr).
